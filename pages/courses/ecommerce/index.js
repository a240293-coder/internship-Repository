        ...
        <section className={styles.hero} aria-labelledby="hero-title">
          <div className={styles.heroContent}>
            ...
            <div className={styles.badges}>
              ...
              <span className={styles.badge}>Internship Certificate</span>
            </div>
            <div className={styles.heroCtas}>
              <Link href="/apply" className={styles.ctaPrimary}>Apply Now</Link>
              <a className={styles.ctaSecondary} href="#syllabus">Download Syllabus</a>
            </div>
          </div>
        ...
        <section className={styles.certificate}>
          ...
          <div className={styles.certRow}>
            ...
            <div>
              ...
              <div className={styles.certCtas}>
                <a className={styles.ctaSecondary} href="#">View Sample Certificate</a>
              </div>
            </div>
          </div>
        </section>
